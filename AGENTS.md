...
The serverless functions have executable test suites; none of them contacts SMTP, Stripe, or the view store:

```
npm test
```

(`node --test test/intake.test.js test/machine-portrait.test.js test/observations.test.js test/observations-publishing.test.js test/observation-views.test.js`.)
