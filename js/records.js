...
const RECORDS = [
  { id: "I-017", f: 0.94, status: "OPEN", withheld: false, title: "Interruption as a primitive of machine work",
  ...
  { id: "I-016", f: 0.79, status: "CLOSED", withheld: false, title: "What a machine looks like when nothing runs",
    question: "IS IDLE A STATE OR AN ABSENCE?", apparatus: "057 · 24 H CAPTURE", finding: "A STATE. IT HAS A SHAPE.", reading: "closed" },
  { id: "I-015", f: 0.63, status: "WITHHELD", withheld: true },
  { id: "I-014", f: 0.47, status: "INCONCLUSIVE", withheld: false, title: "Coordination between agents that never meet",
  ...
  { id: "I-012", f: 0.26, status: "CLOSED", withheld: false, title: "Inference on one small machine, for a year",
  ...
  { id: "I-009", f: 0.06, status: "WITHHELD", withheld: true },
];
